/**
 * Flowtype definitions for sidan_csl_rs
 ...
 * @returns {WasmResult}
 */
declare export function evaluate_tx_scripts_js(
  tx_hex: string,
 ...
 * @returns {string}
 */
declare export function remove_witness_set(tx_hex: string): string;
 ...
 * @returns {string}
 */
declare export function merge_vkey_witnesses_to_transaction(
  tx_hex: string,
 ...
 * @returns {WasmResult}
 */
declare export function js_calculate_tx_hash(tx_hex: string): WasmResult;
 ...
 * @returns {WasmResult}
 */
declare export function js_sign_transaction(
  tx_hex: string,
  signing_keys: JsVecString
): WasmResult;
 ...
 * @returns {WasmResult}
 */
declare export function js_serialize_tx_body(
  tx_builder_body_json: string,
  params_json: string
): WasmResult;
 ...
 * @returns {string}
 */
declare export function js_select_utxos(
  json_str_inputs: string,
  json_str_required_assets: string,
  threshold: string
): string;
 ...
 * @param {string | void} stake_hash
 * @param {boolean} is_script_stake_key
 * @returns {string}
 */
declare export function wasm_script_to_address(
  network_id: number,
  script_hash: string,
  stake_hash: string | void,
  is_script_stake_key: boolean
): string;
 ...
 */
declare export function deserialize_bech32_address(
  bech32_addr: string
): DeserializedAddress;
 ...
 * @returns {string}
 */
declare export function address_bech32_to_obj(bech32: string): string;
 ...
 * @returns {string}
 */
declare export function parse_plutus_address_obj_to_bech32(
  plutus_data_address_obj: string,
  network_id: number
): string;
 ...
 * @returns {string}
 */
declare export function parse_plutus_address_to_bech32(
  plutus_hex: string,
  network_id: number
): string;
 ...
 * @returns {string}
 */
declare export function parse_native_script_address_to_bech32(
 ...
 * @returns {string}
 */
declare export function parse_native_script_address_with_stake_key_to_bech32(
  native_script: string,
 ...
 * @param {$Values<
                typeof 
                BuilderDataType>} param_type
 * @returns {string}
 */
declare export function js_apply_params_to_script(
  plutus_script: string,
  params: JsVecString,
  param_type: $Values<typeof BuilderDataType>
): string;
 ...
 * @returns {string}
 */
declare export function get_v2_script_hash(script: string): string;
...
declare export var BuilderDataType: {|
  +JSON: 0, // 0
  +CBOR: 1, // 1
|};
...
/**
 */
declare export class DeserializedAddress {
  free(): void;
...
/**
 */
declare export class JsVecString {
  free(): void;
...
/**
 */
declare export class WasmResult {
  free(): void;
