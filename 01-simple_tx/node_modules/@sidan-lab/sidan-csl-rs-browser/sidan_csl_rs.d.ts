...
/**
* @param {string} tx_hex
* @param {JsVecString} resolved_utxos
* @param {JsVecString} additional_txs
* @param {string} network
* @returns {WasmResult}
*/
export function evaluate_tx_scripts_js(tx_hex: string, resolved_utxos: JsVecString, additional_txs: JsVecString, network: string): WasmResult;
/**
* @param {string} tx_hex
* @returns {string}
*/
export function remove_witness_set(tx_hex: string): string;
/**
* @param {string} tx_hex
* @param {string} added_witness_set_hex
* @returns {string}
*/
export function merge_vkey_witnesses_to_transaction(tx_hex: string, added_witness_set_hex: string): string;
/**
* @param {string} tx_hex
* @returns {WasmResult}
*/
export function js_calculate_tx_hash(tx_hex: string): WasmResult;
/**
* @param {string} tx_hex
* @param {JsVecString} signing_keys
* @returns {WasmResult}
*/
export function js_sign_transaction(tx_hex: string, signing_keys: JsVecString): WasmResult;
/**
...
* @param {string} tx_builder_body_json
* @param {string} params_json
* @returns {WasmResult}
*/
export function js_serialize_tx_body(tx_builder_body_json: string, params_json: string): WasmResult;
/**
* @param {string} json_str_inputs
* @param {string} json_str_required_assets
* @param {string} threshold
* @returns {string}
*/
export function js_select_utxos(json_str_inputs: string, json_str_required_assets: string, threshold: string): string;
/**
* @param {number} network_id
* @param {string} script_hash
* @param {string | undefined} stake_hash
* @param {boolean} is_script_stake_key
* @returns {string}
*/
export function wasm_script_to_address(network_id: number, script_hash: string, stake_hash: string | undefined, is_script_stake_key: boolean): string;
/**
* @param {string} bech32_addr
* @returns {DeserializedAddress}
*/
export function deserialize_bech32_address(bech32_addr: string): DeserializedAddress;
/**
* @param {string} bech32
* @returns {string}
*/
export function address_bech32_to_obj(bech32: string): string;
/**
* @param {string} plutus_data_address_obj
* @param {number} network_id
* @returns {string}
*/
export function parse_plutus_address_obj_to_bech32(plutus_data_address_obj: string, network_id: number): string;
/**
* @param {string} plutus_hex
* @param {number} network_id
* @returns {string}
*/
export function parse_plutus_address_to_bech32(plutus_hex: string, network_id: number): string;
/**
* @param {string} native_script
* @param {number} network_id
* @returns {string}
*/
export function parse_native_script_address_to_bech32(native_script: string, network_id: number): string;
/**
* @param {string} native_script
* @param {string} stake_key_hash
* @param {number} network_id
* @returns {string}
*/
export function parse_native_script_address_with_stake_key_to_bech32(native_script: string, stake_key_hash: string, network_id: number): string;
/**
* @param {string} plutus_script
* @param {JsVecString} params
* @param {BuilderDataType} param_type
* @returns {string}
*/
export function js_apply_params_to_script(plutus_script: string, params: JsVecString, param_type: BuilderDataType): string;
/**
* @param {string} script
* @returns {string}
*/
export function get_v2_script_hash(script: string): string;
/**
...
/**
*/
export class DeserializedAddress {
  free(): void;
/**
* @param {string} pub_key_hash
* @param {string} script_hash
* @param {string} stake_key_hash
* @param {string} stake_key_script_hash
* @returns {DeserializedAddress}
*/
  static new(pub_key_hash: string, script_hash: string, stake_key_hash: string, stake_key_script_hash: string): DeserializedAddress;
/**
* @returns {string}
*/
  get_pub_key_hash(): string;
/**
* @returns {string}
*/
  get_script_hash(): string;
/**
* @returns {string}
*/
  get_stake_key_hash(): string;
/**
* @returns {string}
*/
  get_stake_key_script_hash(): string;
}
/**
*/
...
/**
*/
export class JsVecString {
  free(): void;
/**
* @returns {JsVecString}
*/
  static new(): JsVecString;
/**
* @returns {number}
*/
  len(): number;
...
* @returns {WasmResult}
*/
  static new(status: string, data: string): WasmResult;
/**
* @param {string} status
* @param {string} error
* @returns {WasmResult}
*/
  static new_error(status: string, error: string): WasmResult;
/**
* @returns {string}
*/
  get_status(): string;
