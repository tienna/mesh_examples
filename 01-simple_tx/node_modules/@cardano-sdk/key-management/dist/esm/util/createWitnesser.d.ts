import { AccountKeyDerivationPath, AsyncKeyAgent, SignBlobResult, SignDataContext, SignTransactionContext, SignTransactionOptions, WitnessOptions, WitnessedTx, Witnesser } from '../types.js';
...
export declare class Bip32Ed25519Witnesser implements Witnesser {
    ...
    signBlob(derivationPath: AccountKeyDerivationPath, blob: HexBlob, _context: SignDataContext): Promise<SignBlobResult>;
