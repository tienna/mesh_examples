...
exports.AssetId.getAssetNameAsText = (id) => {
    const assetName = exports.AssetId.getAssetName(id);
    const assetNameContent = Asset_1.AssetNameLabel.decode(assetName)?.content;
