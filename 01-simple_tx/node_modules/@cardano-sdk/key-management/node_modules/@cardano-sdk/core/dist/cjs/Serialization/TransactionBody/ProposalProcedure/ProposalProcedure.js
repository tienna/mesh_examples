...
class ProposalProcedure {
    ...
    toCbor() {
        ...
        const rewardAddress = Cardano.RewardAddress.fromAddress(Cardano.Address.fromBech32(__classPrivateFieldGet(this, _ProposalProcedure_rewardAccount, "f")));
        if (!rewardAddress) {
    ...
    static fromCbor(cbor) {
        ...
        const rewardAccount = Cardano.Address.fromBytes(util_1.HexBlob.fromBytes(reader.readByteString())).toBech32();
