...
class Voter {
    ...
    static fromCbor(cbor) {
        ...
        switch (kind) {
            ...
            case VoterKind_1.VoterKind.StakePoolKeyHash:
                credential = { hash, type: Cardano_1.CredentialType.KeyHash };
                break;
            case VoterKind_1.VoterKind.ConstitutionalCommitteeScriptHash:
            case VoterKind_1.VoterKind.DRepScriptHash:
                credential = { hash, type: Cardano_1.CredentialType.ScriptHash };
                break;
            default:
    ...
    toCore() {
        switch (__classPrivateFieldGet(this, _Voter_kind, "f")) {
            case VoterKind_1.VoterKind.ConstitutionalCommitteeKeyHash:
                return {
                    __typename: Cardano_1.VoterType.ccHotKeyHash,
                    credential: {
                        hash: __classPrivateFieldGet(this, _Voter_credential, "f").hash,
                        type: Cardano_1.CredentialType.KeyHash
                    }
                };
            case VoterKind_1.VoterKind.ConstitutionalCommitteeScriptHash:
                return {
                    __typename: Cardano_1.VoterType.ccHotScriptHash,
                    credential: {
                        hash: __classPrivateFieldGet(this, _Voter_credential, "f").hash,
                        type: Cardano_1.CredentialType.ScriptHash
                    }
                };
            case VoterKind_1.VoterKind.DrepKeyHash:
                return {
                    __typename: Cardano_1.VoterType.dRepKeyHash,
                    credential: {
                        hash: __classPrivateFieldGet(this, _Voter_credential, "f").hash,
                        type: Cardano_1.CredentialType.KeyHash
                    }
            ...
            case VoterKind_1.VoterKind.DRepScriptHash:
                return {
                    __typename: Cardano_1.VoterType.dRepScriptHash,
                    credential: {
                        hash: __classPrivateFieldGet(this, _Voter_credential, "f").hash,
                        type: Cardano_1.CredentialType.ScriptHash
                    }
            ...
            case VoterKind_1.VoterKind.StakePoolKeyHash:
                return {
                    __typename: Cardano_1.VoterType.stakePoolKeyHash,
                    credential: {
                        hash: __classPrivateFieldGet(this, _Voter_credential, "f").hash,
                        type: Cardano_1.CredentialType.KeyHash
                    }
    ...
    static fromCore(coreVoter) {
        ...
        switch (coreVoter.__typename) {
            case Cardano_1.VoterType.ccHotKeyHash:
            case Cardano_1.VoterType.ccHotScriptHash:
                voter = Voter.newConstitutionalCommitteeHotKey(coreVoter.credential);
                break;
            case Cardano_1.VoterType.dRepKeyHash:
            case Cardano_1.VoterType.dRepScriptHash:
                voter = Voter.newDrep(coreVoter.credential);
                break;
            case Cardano_1.VoterType.stakePoolKeyHash:
    ...
    static newConstitutionalCommitteeHotKey(credential) {
        const kind = credential.type === Cardano_1.CredentialType.KeyHash
    ...
    static newDrep(credential) {
        const kind = credential.type === Cardano_1.CredentialType.KeyHash ? VoterKind_1.VoterKind.DrepKeyHash : VoterKind_1.VoterKind.DRepScriptHash;
        return new Voter(kind, credential);
    }
