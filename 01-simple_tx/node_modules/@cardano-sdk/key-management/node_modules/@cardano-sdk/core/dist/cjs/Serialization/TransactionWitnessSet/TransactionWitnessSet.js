...
exports.TransactionWitnessSet = void 0;
const Cardano = __importStar(require("../../Cardano"));
const BootstrapWitness_1 = require("./BootstrapWitness");
const CBOR_1 = require("../CBOR");
const Common_1 = require("../Common");
const util_1 = require("@cardano-sdk/util");
const Scripts_1 = require("../Scripts");
const PlutusData_1 = require("../PlutusData/PlutusData");
const Redeemer_1 = require("./Redeemer");
const errors_1 = require("../../errors");
const VkeyWitness_1 = require("./VkeyWitness");
...
class TransactionWitnessSet {
    ...
    toCbor() {
        ...
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_vkeywitnesses, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_vkeywitnesses, "f").size() > 0) {
            __classPrivateFieldGet(this, _TransactionWitnessSet_vkeywitnesses, "f").setValues((0, uniqWith_js_1.default)(__classPrivateFieldGet(this, _TransactionWitnessSet_vkeywitnesses, "f").values(), (lhs, rhs) => lhs.vkey() === rhs.vkey()));
            writer.writeInt(0n);
            writer.writeEncodedValue(Buffer.from(__classPrivateFieldGet(this, _TransactionWitnessSet_vkeywitnesses, "f").toCbor(), 'hex'));
        }
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_nativeScripts, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_nativeScripts, "f").size() > 0) {
            writer.writeInt(1n);
            writer.writeEncodedValue(Buffer.from(__classPrivateFieldGet(this, _TransactionWitnessSet_nativeScripts, "f").toCbor(), 'hex'));
        }
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_bootstrapWitnesses, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_bootstrapWitnesses, "f").size() > 0) {
            __classPrivateFieldGet(this, _TransactionWitnessSet_bootstrapWitnesses, "f").setValues((0, uniqWith_js_1.default)(__classPrivateFieldGet(this, _TransactionWitnessSet_bootstrapWitnesses, "f").values(), (lhs, rhs) => lhs.vkey() === rhs.vkey()));
            writer.writeInt(2n);
            writer.writeEncodedValue(Buffer.from(__classPrivateFieldGet(this, _TransactionWitnessSet_bootstrapWitnesses, "f").toCbor(), 'hex'));
        }
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_plutusV1Scripts, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_plutusV1Scripts, "f").size() > 0) {
            writer.writeInt(3n);
            writer.writeEncodedValue(Buffer.from(__classPrivateFieldGet(this, _TransactionWitnessSet_plutusV1Scripts, "f").toCbor(), 'hex'));
        }
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_plutusData, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_plutusData, "f").size() > 0) {
            writer.writeInt(4n);
            writer.writeEncodedValue(Buffer.from(__classPrivateFieldGet(this, _TransactionWitnessSet_plutusData, "f").toCbor(), 'hex'));
        }
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_redeemers, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_redeemers, "f").size() > 0) {
            writer.writeInt(5n);
            writer.writeEncodedValue((0, misc_1.hexToBytes)(__classPrivateFieldGet(this, _TransactionWitnessSet_redeemers, "f").toCbor()));
        }
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_plutusV2Scripts, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_plutusV2Scripts, "f").size() > 0) {
            writer.writeInt(6n);
            writer.writeEncodedValue(Buffer.from(__classPrivateFieldGet(this, _TransactionWitnessSet_plutusV2Scripts, "f").toCbor(), 'hex'));
        }
        if (__classPrivateFieldGet(this, _TransactionWitnessSet_plutusV3Scripts, "f") && __classPrivateFieldGet(this, _TransactionWitnessSet_plutusV3Scripts, "f").size() > 0) {
            writer.writeInt(7n);
    ...
    static fromCbor(cbor) {
        ...
        while (reader.peekState() !== CBOR_1.CborReaderState.EndMap) {
            ...
            switch (key) {
                case 0n:
                    witness.setVkeys(Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), VkeyWitness_1.VkeyWitness.fromCbor));
                    break;
                case 1n:
                    witness.setNativeScripts(Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), Scripts_1.NativeScript.fromCbor));
                    break;
                case 2n:
                    witness.setBootstraps(Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), BootstrapWitness_1.BootstrapWitness.fromCbor));
                    break;
                case 3n:
                    witness.setPlutusV1Scripts(Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), Scripts_1.PlutusV1Script.fromCbor));
                    break;
                case 4n:
                    witness.setPlutusData(Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), PlutusData_1.PlutusData.fromCbor));
                    break;
                case 5n: {
                    witness.setRedeemers(Redeemer_1.Redeemers.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue())));
                    break;
                }
                case 6n:
                    witness.setPlutusV2Scripts(Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), Scripts_1.PlutusV2Script.fromCbor));
                    break;
                case 7n:
                    witness.setPlutusV3Scripts(Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), Scripts_1.PlutusV3Script.fromCbor));
                    break;
            }
        }
        reader.readEndMap();
    ...
    static fromCore(coreWitness) {
        ...
        if (coreWitness.signatures) {
            witness.setVkeys(Common_1.CborSet.fromCore([...coreWitness.signatures], VkeyWitness_1.VkeyWitness.fromCore));
        }
        ...
        if (coreWitness.redeemers) {
            witness.setRedeemers(Redeemer_1.Redeemers.fromCore(coreWitness.redeemers));
        }
        if (coreWitness.datums) {
            witness.setPlutusData(Common_1.CborSet.fromCore(coreWitness.datums, PlutusData_1.PlutusData.fromCore));
        }
        if (coreWitness.bootstrap) {
            witness.setBootstraps(Common_1.CborSet.fromCore(coreWitness.bootstrap, BootstrapWitness_1.BootstrapWitness.fromCore));
        }
        return witness;
    }
    setVkeys(vkeys) {
...
_a = TransactionWitnessSet, _TransactionWitnessSet_vkeywitnesses = new WeakMap(), _TransactionWitnessSet_nativeScripts = new WeakMap(), _TransactionWitnessSet_bootstrapWitnesses = new WeakMap(), _TransactionWitnessSet_plutusV1Scripts = new WeakMap(), _TransactionWitnessSet_plutusData = new WeakMap(), _TransactionWitnessSet_redeemers = new WeakMap(), _TransactionWitnessSet_plutusV2Scripts = new WeakMap(), _TransactionWitnessSet_plutusV3Scripts = new WeakMap(), _TransactionWitnessSet_originalBytes = new WeakMap(), _TransactionWitnessSet_instances = new WeakSet(), _TransactionWitnessSet_getCoreScripts = function _TransactionWitnessSet_getCoreScripts() {
    ...
    return {
        ...(coreNative && { native: Common_1.CborSet.fromCore(coreNative, Scripts_1.NativeScript.fromCore) }),
        ...(coreV1 && { plutusV1: Common_1.CborSet.fromCore(coreV1, Scripts_1.PlutusV1Script.fromCore) }),
        ...(coreV2 && { plutusV2: Common_1.CborSet.fromCore(coreV2, Scripts_1.PlutusV2Script.fromCore) }),
        ...(coreV3 && { plutusV3: Common_1.CborSet.fromCore(coreV3, Scripts_1.PlutusV3Script.fromCore) })
    };
