...
exports.StakeDelegation = void 0;
...
class StakeDelegation {
    ...
    toCbor() {
        ...
        writer.writeInt(CertificateKind_1.CertificateKind.StakeDelegation);
    ...
    static fromCbor(cbor) {
        ...
        if (kind !== CertificateKind_1.CertificateKind.StakeDelegation)
            throw new util_1.InvalidArgumentError('cbor', `Expected certificate kind ${CertificateKind_1.CertificateKind.StakeDelegation}, but got ${kind}`);
        const credLength = reader.readStartArray();
        if (credLength !== CREDENTIAL_SIZE)
            throw new util_1.InvalidArgumentError('cbor', `Expected an array of ${CREDENTIAL_SIZE} elements, but got an array of ${length} elements`);
    ...
    toCore() {
        return {
            ...
            poolId: Cardano.PoolId.fromKeyHash(__classPrivateFieldGet(this, _StakeDelegation_poolKeyHash, "f")),
...
//# sourceMappingURL=StakeDelegation.js.map