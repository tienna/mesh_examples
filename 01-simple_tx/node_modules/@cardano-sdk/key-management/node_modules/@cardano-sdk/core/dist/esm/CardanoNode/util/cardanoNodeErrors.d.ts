import { ChainSyncError, ChainSyncErrorCode, GeneralCardanoNodeError, GeneralCardanoNodeErrorCode, IncompleteWithdrawalsData, OutsideOfValidityIntervalData, StateQueryError, StateQueryErrorCode, TxSubmissionError, TxSubmissionErrorCode, UnknownOutputReferencesData, ValueNotConservedData } from '../types/index.js';
...
export declare const isProviderError: (error: unknown) => error is ProviderError<unknown>;
