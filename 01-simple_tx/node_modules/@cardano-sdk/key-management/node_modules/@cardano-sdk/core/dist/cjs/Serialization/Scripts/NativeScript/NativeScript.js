...
class NativeScript {
    ...
    static newScriptPubkey(scriptPubkey) {
        ...
        __classPrivateFieldSet(script, _NativeScript_kind, Cardano.NativeScriptKind.RequireSignature, "f");
        return script;
    }
    static newScriptAll(scriptAll) {
        const script = new NativeScript();
        __classPrivateFieldSet(script, _NativeScript_scriptAll, scriptAll, "f");
        __classPrivateFieldSet(script, _NativeScript_kind, Cardano.NativeScriptKind.RequireAllOf, "f");
        return script;
    }
    static newScriptAny(scriptAny) {
        const script = new NativeScript();
        __classPrivateFieldSet(script, _NativeScript_scriptAny, scriptAny, "f");
        __classPrivateFieldSet(script, _NativeScript_kind, Cardano.NativeScriptKind.RequireAnyOf, "f");
        return script;
    }
    static newScriptNOfK(scriptNOfK) {
        const script = new NativeScript();
        __classPrivateFieldSet(script, _NativeScript_scripNOfK, scriptNOfK, "f");
        __classPrivateFieldSet(script, _NativeScript_kind, Cardano.NativeScriptKind.RequireNOf, "f");
        return script;
    }
    static newTimelockStart(timelockStart) {
        const script = new NativeScript();
        __classPrivateFieldSet(script, _NativeScript_timelockStart, timelockStart, "f");
        __classPrivateFieldSet(script, _NativeScript_kind, Cardano.NativeScriptKind.RequireTimeAfter, "f");
        return script;
    }
    static newTimelockExpiry(timelockExpiry) {
        const script = new NativeScript();
        __classPrivateFieldSet(script, _NativeScript_timelockExpiry, timelockExpiry, "f");
        __classPrivateFieldSet(script, _NativeScript_kind, Cardano.NativeScriptKind.RequireTimeBefore, "f");
        return script;
    }
    asScriptPubkey() {
