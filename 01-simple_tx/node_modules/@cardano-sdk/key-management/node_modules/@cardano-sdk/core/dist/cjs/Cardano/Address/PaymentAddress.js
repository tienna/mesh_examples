...
exports.addressNetworkId = exports.inputsWithAddresses = exports.isAddressWithin = exports.PaymentAddress = void 0;
...
const PaymentAddress = (value) => {
    if (Address_1.Address.isValid(value)) {
        if (isRewardAccount(value) || DRepID_1.DRepID.isValid(value)) {
