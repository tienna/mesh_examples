...
class ScriptAny {
    ...
    static fromCbor(cbor) {
        ...
        if (kind !== Cardano.NativeScriptKind.RequireAnyOf)
            throw new util_1.InvalidArgumentError('cbor', `Expected kind ${Cardano.NativeScriptKind.RequireAnyOf}, but got kind ${kind}`);
    ...
    static fromCore(script) {
        return new ScriptAny(script.scripts.map((nativeScript) => NativeScript_1.NativeScript.fromCore(nativeScript)));
    }
    nativeScripts() {
