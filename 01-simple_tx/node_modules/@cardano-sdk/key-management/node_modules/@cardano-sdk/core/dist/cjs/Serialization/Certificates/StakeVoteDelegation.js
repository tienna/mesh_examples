...
class StakeVoteDelegation {
    ...
    toCore() {
        return {
            __typename: Cardano_1.CertificateType.StakeVoteDelegation,
            dRep: __classPrivateFieldGet(this, _StakeVoteDelegation_dRep, "f").toCore(),
            poolId: Cardano.PoolId.fromKeyHash(__classPrivateFieldGet(this, _StakeVoteDelegation_poolKeyHash, "f")),
            stakeCredential: __classPrivateFieldGet(this, _StakeVoteDelegation_credential, "f")
        };
    }
    static fromCore(deleg) {
        return new StakeVoteDelegation(deleg.stakeCredential, DRep_1.DRep.fromCore(deleg.dRep), Cardano.PoolId.toKeyHash(deleg.poolId));
    }
    stakeCredential() {
