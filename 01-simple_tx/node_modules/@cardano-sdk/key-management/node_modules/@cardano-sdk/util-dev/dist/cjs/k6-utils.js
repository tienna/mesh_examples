...
exports.SdkCom = exports.chunkArray = exports.getDut = exports.Network = exports.Environment = void 0;
var Environment;
...
class SdkCom {
    ...
    txsByAddress(addresses, takeOne = false, pageSize = 25) {
        const addressChunks = (0, exports.chunkArray)(addresses, pageSize);
    ...
    utxosByAddresses(addresses) {
        const addressChunks = (0, exports.chunkArray)(addresses, 25);
        for (const chunk of addressChunks) {
