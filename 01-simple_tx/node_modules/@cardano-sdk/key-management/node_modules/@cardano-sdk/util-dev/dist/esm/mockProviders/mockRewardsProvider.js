...
import { epochRewards, rewardAccountBalance, rewardAccountBalance2, rewardsHistory, rewardsHistory2 } from './mockData.js';
import { getRandomTxId } from './mockChainHistoryProvider.js';
import delay from 'delay';
export const mockRewardsProvider = ({ rewardAccount } = {}) => ({
...
export const mockRewardsProvider2 = (delayMs) => {
...
export const generateStakePools = (qty) => [...Array.from({ length: qty }).keys()].map(() => ({
    cost: 340000000n,
    ...
    metrics: {
        ...
        ros: Percent(0),
        saturation: Percent(0.00003555210355859188),
        size: {
            active: Percent(1),
            live: Percent(0)
        },
...
export const stakePoolsPaginated = {
...
export const mockStakePoolsProvider = () => ({
    healthCheck: jest.fn().mockResolvedValue({ ok: true }),
