...
export declare abstract class KeyAgentBase implements KeyAgent {
    ...
    abstract signTransaction(txBody: Serialization.TransactionBody, context: SignTransactionContext, signTransactionOptions?: SignTransactionOptions): Promise<Cardano.Signatures>;
