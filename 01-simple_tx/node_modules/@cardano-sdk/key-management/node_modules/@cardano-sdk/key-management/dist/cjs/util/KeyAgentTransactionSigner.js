...
exports.KeyAgentTransactionSigner = void 0;
const errors_1 = require("../errors");
const EXPECTED_SIG_NUM = 1;
class KeyAgentTransactionSigner {
    ...
    async sign(txBody) {
        const signatures = await __classPrivateFieldGet(this, _KeyAgentTransactionSigner_keyAgent, "f").signTransaction(txBody, {
            knownAddresses: [],
            txInKeyPathMap: {}
        }, {
        ...
        if (signatures.size !== EXPECTED_SIG_NUM)
            throw new errors_1.ProofGenerationError(`Invalid number of signatures. Expected ${EXPECTED_SIG_NUM} and got ${signatures.size}`);
        const [pubKey] = signatures.keys();
        const [signature] = signatures.values();
        return { pubKey, signature };
    }
}
exports.KeyAgentTransactionSigner = KeyAgentTransactionSigner;
