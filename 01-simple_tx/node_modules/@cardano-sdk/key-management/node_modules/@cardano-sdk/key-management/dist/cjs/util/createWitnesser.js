...
class Bip32Ed25519Witnesser {
    ...
    async witness(tx, context, options) {
        ...
        const signatures = options?.stubSign !== undefined && options.stubSign
            ...
            : await Bip32Ed25519Witnesser.getSignatures(__classPrivateFieldGet(this, _Bip32Ed25519Witnesser_keyAgent, "f"), tx.body(), context, options);
        const transaction = {
        ...
        return {
            cbor: core_1.Serialization.TxCBOR.serialize(transaction),
            context: {
    ...
    async signData(props) {
        return __classPrivateFieldGet(this, _Bip32Ed25519Witnesser_keyAgent, "f").signCip8Data(props);
    }
    static async getSignatures(keyAgent, txBody, context, options) {
