...
import { Cip8SignDataContext } from './cip8/index.js';
...
export declare class InMemoryKeyAgent extends KeyAgentBase implements KeyAgent {
    ...
    signTransaction(txBody: Serialization.TransactionBody, { txInKeyPathMap, knownAddresses }: SignTransactionContext, { additionalKeyPaths }?: SignTransactionOptions): Promise<Cardano.Signatures>;
