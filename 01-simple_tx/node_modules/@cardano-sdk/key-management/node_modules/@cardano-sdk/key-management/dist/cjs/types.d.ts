...
export declare type SignDataContext = Cip8SignDataContext & {
    sender?: MessageSender;
};
export interface KeyAgent {
    ...
    signTransaction(txBody: Serialization.TransactionBody, context: SignTransactionContext, options?: SignTransactionOptions): Promise<Cardano.Signatures>;
...
export declare type AsyncKeyAgent = Pick<KeyAgent, 'deriveAddress' | 'derivePublicKey' | 'signBlob' | 'signCip8Data' | 'signTransaction'> & {
