...
import { DRepInfo } from '../../Provider/index.js';
...
export declare const isDrepInfo: (drep: DelegateRepresentative | DRepInfo) => drep is DRepInfo;
export declare const isDRepCredential: (deleg: DelegateRepresentative | DRepInfo) => deleg is Credential;
export declare const isDRepAlwaysAbstain: (deleg: DelegateRepresentative | DRepInfo) => deleg is AlwaysAbstain;
export declare const isDRepAlwaysNoConfidence: (deleg: DelegateRepresentative | DRepInfo) => deleg is AlwaysNoConfidence;
