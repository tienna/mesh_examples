...
exports.isDRepAlwaysNoConfidence = exports.isDRepAlwaysAbstain = exports.isDRepCredential = exports.isDrepInfo = exports.VoterType = exports.Vote = exports.GovernanceActionType = void 0;
...
})(GovernanceActionType = exports.GovernanceActionType || (exports.GovernanceActionType = {}));
var Vote;
(function (Vote) {
    Vote[Vote["no"] = 0] = "no";
    Vote[Vote["yes"] = 1] = "yes";
...
exports.isDrepInfo = isDrepInfo;
const isDRepCredential = (deleg) => 'type' in deleg && 'hash' in deleg;
exports.isDRepCredential = isDRepCredential;
const isDRepAlwaysAbstain = (deleg) => '__typename' in deleg && deleg.__typename === 'AlwaysAbstain';
exports.isDRepAlwaysAbstain = isDRepAlwaysAbstain;
const isDRepAlwaysNoConfidence = (deleg) => '__typename' in deleg && deleg.__typename === 'AlwaysNoConfidence';
exports.isDRepAlwaysNoConfidence = isDRepAlwaysNoConfidence;
