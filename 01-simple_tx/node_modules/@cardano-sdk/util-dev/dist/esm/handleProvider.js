...
export const axiosError = (bodyError = new Error('error'), reason = ProviderFailure.BadRequest) => {
    const response = {
...
export const getAliceHandleProviderResponse = {
    cardanoAddress: Cardano.PaymentAddress('addr_test1qqk4sr4f7vtqzd2w90d5nfu3n59jhhpawyphnek2y7er02nkrezryq3ydtmkg0e7e2jvzg443h0ffzfwd09wpcxy2fuqmcnecd'),
    handle: 'alice',
    hasDatum: false,
