...
exports.StakeDeregistration = void 0;
...
class StakeDeregistration {
    ...
    toCbor() {
        ...
        writer.writeInt(CertificateKind_1.CertificateKind.StakeDeregistration);
        writer.writeStartArray(EMBEDDED_GROUP_SIZE);
    ...
    static fromCbor(cbor) {
        ...
        if (kind !== CertificateKind_1.CertificateKind.StakeDeregistration)
            throw new util_1.InvalidArgumentError('cbor', `Expected certificate kind ${CertificateKind_1.CertificateKind.StakeDeregistration}, but got ${kind}`);
...
//# sourceMappingURL=StakeDeregistration.js.map