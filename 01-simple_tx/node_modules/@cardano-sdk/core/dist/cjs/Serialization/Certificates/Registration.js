...
class Registration {
    ...
    toCbor() {
        ...
        writer.writeInt(CertificateKind_1.CertificateKind.Registration);
    ...
    static fromCbor(cbor) {
        ...
        if (kind !== CertificateKind_1.CertificateKind.Registration)
            throw new util_1.InvalidArgumentError('cbor', `Expected certificate kind ${CertificateKind_1.CertificateKind.Registration}, but got ${kind}`);
