...
exports.AuthCommitteeHot = void 0;
...
class AuthCommitteeHot {
    ...
    toCbor() {
        ...
        writer.writeInt(CertificateKind_1.CertificateKind.AuthCommitteeHot);
    ...
    static fromCbor(cbor) {
        ...
        if (kind !== CertificateKind_1.CertificateKind.AuthCommitteeHot)
            throw new util_1.InvalidArgumentError('cbor', `Expected certificate kind ${CertificateKind_1.CertificateKind.AuthCommitteeHot}, but got ${kind}`);
        ...
        const hotHash = Crypto.Hash28ByteBase16(util_1.HexBlob.fromBytes(reader.readByteString()));
        reader.readEndArray();
        reader.readEndArray();
    ...
    toCore() {
        return {
            __typename: Cardano_1.CertificateType.AuthorizeCommitteeHot,
...
exports.AuthCommitteeHot = AuthCommitteeHot;
...
//# sourceMappingURL=AuthCommitteeHot.js.map