...
class ProtocolParamUpdate {
    ...
    toCore() {
        return {
            ...
            committeeTermLimit: __classPrivateFieldGet(this, _ProtocolParamUpdate_committeeTermLimit, "f"),
    ...
    static fromCore(parametersUpdate) {
        ...
        __classPrivateFieldSet(params, _ProtocolParamUpdate_treasuryGrowthRate, parametersUpdate.treasuryExpansion
            ...
            : undefined, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_d, parametersUpdate.decentralizationParameter
            ? Common_1.UnitInterval.fromFloat(Number(parametersUpdate.decentralizationParameter))
            : undefined, "f");
