...
var _PoolVotingThresholds_motionNoConfidence, _PoolVotingThresholds_committeeNormal, _PoolVotingThresholds_committeeNoConfidence, _PoolVotingThresholds_hardForkInitiation, _PoolVotingThresholds_originalBytes;
...
class PoolVotingThresholds {
    constructor(motionNoConfidence, committeeNormal, committeeNoConfidence, hardForkInitiation) {
    ...
    static fromCbor(cbor) {
        ...
        reader.readEndArray();
        const thresholds = new PoolVotingThresholds(motionNoConfidence, committeeNormal, committeeNoConfidence, hardForkInitiation);
    ...
    static fromCore(core) {
        return new PoolVotingThresholds(Common_1.UnitInterval.fromCore(core.motionNoConfidence), Common_1.UnitInterval.fromCore(core.committeeNormal), Common_1.UnitInterval.fromCore(core.committeeNoConfidence), Common_1.UnitInterval.fromCore(core.hardForkInitiation));
    }
...
_PoolVotingThresholds_motionNoConfidence = new WeakMap(), _PoolVotingThresholds_committeeNormal = new WeakMap(), _PoolVotingThresholds_committeeNoConfidence = new WeakMap(), _PoolVotingThresholds_hardForkInitiation = new WeakMap(), _PoolVotingThresholds_originalBytes = new WeakMap();
