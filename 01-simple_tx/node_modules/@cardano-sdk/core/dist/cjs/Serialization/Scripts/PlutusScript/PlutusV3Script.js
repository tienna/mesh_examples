...
class PlutusV3Script {
    ...
    static fromCbor(cbor) {
        ...
        const script = new PlutusV3Script(util_1.HexBlob.fromBytes(bytes));
    ...
    static fromCore(plutusScript) {
        if (plutusScript.version !== Cardano.PlutusLanguageVersion.V3)
            throw new util_1.InvalidArgumentError('script', 'Wrong plutus language version.');
