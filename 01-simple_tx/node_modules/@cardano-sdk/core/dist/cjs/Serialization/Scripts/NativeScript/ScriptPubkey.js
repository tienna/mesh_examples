...
class ScriptPubkey {
    ...
    static fromCbor(cbor) {
        ...
        if (kind !== Cardano.NativeScriptKind.RequireSignature)
            throw new util_1.InvalidArgumentError('cbor', `Expected kind ${Cardano.NativeScriptKind.RequireSignature}, but got kind ${kind}`);
        const key = Crypto.Ed25519KeyHashHex(util_1.HexBlob.fromBytes(reader.readByteString()));
...
//# sourceMappingURL=ScriptPubkey.js.map