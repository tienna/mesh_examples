...
class ScriptAll {
    ...
    static fromCbor(cbor) {
        ...
        if (kind !== Cardano.NativeScriptKind.RequireAllOf)
            throw new util_1.InvalidArgumentError('cbor', `Expected kind ${Cardano.NativeScriptKind.RequireAllOf}, but got kind ${kind}`);
    ...
    static fromCore(script) {
        return new ScriptAll(script.scripts.map((nativeScript) => NativeScript_1.NativeScript.fromCore(nativeScript)));
    }
    nativeScripts() {
...
//# sourceMappingURL=ScriptAll.js.map