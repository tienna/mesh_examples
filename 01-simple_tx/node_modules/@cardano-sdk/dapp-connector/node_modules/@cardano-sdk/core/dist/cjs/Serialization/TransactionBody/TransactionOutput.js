...
class TransactionOutput {
    ...
    toCore() {
        ...
        if (__classPrivateFieldGet(this, _TransactionOutput_datum, "f") && __classPrivateFieldGet(this, _TransactionOutput_datum, "f").kind() === Datum_1.DatumKind.InlineData)
            txOut.datum = __classPrivateFieldGet(this, _TransactionOutput_datum, "f").asInlineData()?.toCore();
        if (__classPrivateFieldGet(this, _TransactionOutput_datum, "f") && __classPrivateFieldGet(this, _TransactionOutput_datum, "f").kind() === Datum_1.DatumKind.DataHash)
