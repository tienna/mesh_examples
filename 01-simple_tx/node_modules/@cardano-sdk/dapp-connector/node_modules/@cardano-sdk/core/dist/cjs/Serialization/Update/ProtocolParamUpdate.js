...
const DrepVotingThresholds_1 = require("./DrepVotingThresholds");
const Block_1 = require("../../Cardano/types/Block");
const ExUnitPrices_1 = require("./ExUnitPrices");
const Common_1 = require("../Common");
const util_1 = require("@cardano-sdk/util");
const PoolVotingThresholds_1 = require("./PoolVotingThresholds");
class ProtocolParamUpdate {
        ...
        while (reader.peekState() !== CBOR_1.CborReaderState.EndMap) {
            ...
            switch (key) {
                ...
                case 24n:
                    ...
                    break;
                case 25n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_poolVotingThresholds, PoolVotingThresholds_1.PoolVotingThresholds.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue())), "f");
                    break;
                case 26n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_drepVotingThresholds, DrepVotingThresholds_1.DrepVotingThresholds.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue())), "f");
                    break;
                case 27n:
                ...
                case 32n:
                    ...
                    break;
                case 33n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_minFeeRefScriptCostPerByte, Common_1.UnitInterval.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue())), "f");
                    break;
            }
        }
        reader.readEndMap();
    ...
    toCore() {
        const protocolParametersUpdate = {
            ...
            committeeTermLimit: __classPrivateFieldGet(this, _ProtocolParamUpdate_committeeTermLimit, "f") ? (0, Block_1.EpochNo)(__classPrivateFieldGet(this, _ProtocolParamUpdate_committeeTermLimit, "f")) : undefined,
            ...
            dRepInactivityPeriod: __classPrivateFieldGet(this, _ProtocolParamUpdate_drepInactivityPeriod, "f") ? (0, Block_1.EpochNo)(__classPrivateFieldGet(this, _ProtocolParamUpdate_drepInactivityPeriod, "f")) : undefined,
            ...
            governanceActionValidityPeriod: __classPrivateFieldGet(this, _ProtocolParamUpdate_governanceActionValidityPeriod, "f")
                ? (0, Block_1.EpochNo)(__classPrivateFieldGet(this, _ProtocolParamUpdate_governanceActionValidityPeriod, "f"))
                : undefined,
    ...
    static fromCore(parametersUpdate) {
        ...
        __classPrivateFieldSet(params, _ProtocolParamUpdate_poolPledgeInfluence, parametersUpdate.poolInfluence
            ? Common_1.UnitInterval.fromFloat(Number(parametersUpdate.poolInfluence))
            : undefined, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_expansionRate, parametersUpdate.monetaryExpansion
            ? Common_1.UnitInterval.fromFloat(Number(parametersUpdate.monetaryExpansion))
            : undefined, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_treasuryGrowthRate, parametersUpdate.treasuryExpansion
            ? Common_1.UnitInterval.fromFloat(Number(parametersUpdate.treasuryExpansion))
            : undefined, "f");
        ...
        __classPrivateFieldSet(params, _ProtocolParamUpdate_poolVotingThresholds, parametersUpdate.poolVotingThresholds
            ? PoolVotingThresholds_1.PoolVotingThresholds.fromCore(parametersUpdate.poolVotingThresholds)
            : undefined, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_drepVotingThresholds, parametersUpdate.dRepVotingThresholds
            ? DrepVotingThresholds_1.DrepVotingThresholds.fromCore(parametersUpdate.dRepVotingThresholds)
            : undefined, "f");
        ...
        __classPrivateFieldSet(params, _ProtocolParamUpdate_minFeeRefScriptCostPerByte, parametersUpdate.minFeeRefScriptCostPerByte
            ? Common_1.UnitInterval.fromFloat(Number(parametersUpdate.minFeeRefScriptCostPerByte))
            : undefined, "f");
        ...
        if (protocolVersion !== undefined || extraEntropy !== undefined || decentralizationParameter) {
            __classPrivateFieldSet(params, _ProtocolParamUpdate_d, decentralizationParameter ? Common_1.UnitInterval.fromFloat(Number(decentralizationParameter)) : undefined, "f");
            __classPrivateFieldSet(params, _ProtocolParamUpdate_protocolVersion, protocolVersion ? Common_1.ProtocolVersion.fromCore(protocolVersion) : undefined, "f");
            __classPrivateFieldSet(params, _ProtocolParamUpdate_extraEntropy, extraEntropy ? (0, util_1.HexBlob)(extraEntropy) : undefined, "f");
        }
        return params;
    }
    setMinFeeA(minFeeA) {
