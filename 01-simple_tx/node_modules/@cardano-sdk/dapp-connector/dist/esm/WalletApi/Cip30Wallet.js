...
var _Cip30Wallet_instances, _Cip30Wallet_logger, _Cip30Wallet_api, _Cip30Wallet_authenticator, _Cip30Wallet_deviations, _Cip30Wallet_validateExtensions, _Cip30Wallet_wrapGetCollateral, _Cip30Wallet_wrapAndEnableApi;
...
export class Cip30Wallet {
    constructor(properties, { api, authenticator, logger }) {
        ...
        _Cip30Wallet_deviations.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _Cip30Wallet_deviations, properties.cip30ApiDeviations, "f");
    ...
    async enable(options) {
        ...
        if (await __classPrivateFieldGet(this, _Cip30Wallet_authenticator, "f").requestAccess()) {
            ...
            return __classPrivateFieldGet(this, _Cip30Wallet_instances, "m", _Cip30Wallet_wrapAndEnableApi).call(this, extensions);
        }
...
_Cip30Wallet_logger = new WeakMap(), _Cip30Wallet_api = new WeakMap(), _Cip30Wallet_authenticator = new WeakMap(), _Cip30Wallet_deviations = new WeakMap(), _Cip30Wallet_instances = new WeakSet(), _Cip30Wallet_validateExtensions = function _Cip30Wallet_validateExtensions(extensions = []) {
...
}, _Cip30Wallet_wrapGetCollateral = async function _Cip30Wallet_wrapGetCollateral(params) {
    const collateral = await __classPrivateFieldGet(this, _Cip30Wallet_api, "f").getCollateral(params);
    return __classPrivateFieldGet(this, _Cip30Wallet_deviations, "f")?.getCollateralEmptyArray ? collateral ?? [] : collateral;
}, _Cip30Wallet_wrapAndEnableApi = function _Cip30Wallet_wrapAndEnableApi(enabledExtensions) {
    const walletApi = __classPrivateFieldGet(this, _Cip30Wallet_api, "f");
    const baseApi = {
        experimental: {
            getCollateral: async (params) => __classPrivateFieldGet(this, _Cip30Wallet_instances, "m", _Cip30Wallet_wrapGetCollateral).call(this, params),
            ...(__classPrivateFieldGet(this, _Cip30Wallet_deviations, "f")?.onOffDummyMethods && { off: () => void 0, on: () => void 0 })
        },
        getBalance: () => walletApi.getBalance(),
        getChangeAddress: () => walletApi.getChangeAddress(),
        getCollateral: (params) => __classPrivateFieldGet(this, _Cip30Wallet_instances, "m", _Cip30Wallet_wrapGetCollateral).call(this, params),
