...
export async function getSmartContractInfoForTx() {
  const sc_utxos = await blockchainProvider.fetchAddressUTxOs("addr_test1wpy36aygslqz3cqe8pd3wjnxmusjafkp6try0peq825gaycace8ya");
  if (sc_utxos?.length === 0) {
